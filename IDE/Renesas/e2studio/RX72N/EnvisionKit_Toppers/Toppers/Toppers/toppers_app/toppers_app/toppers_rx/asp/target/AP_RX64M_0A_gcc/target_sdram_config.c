 ...
 */
  ...
  *    tREF/Row addressing : 15.625usec
  *    CAS latency : 2 cycle
  */
...
target_sdram_config( void ){
  ...
  sil_wrh_mem((uint16_t *)BUS_SDIR_ADDR,
              ...
              BUS_SDIR_PRC_3     //over tRP(18 ns) Tsd*3 can't set lower 3
              );
  ...
  /* b15    Reserved - The write value should be 0.
    b14:b0 MR[14:0] - Mode Register Setting - Writing to these bits: Mode register set command is issued
                      Mode register definition for M12L128168A
  ...
  sil_wrw_mem((uint32_t*)BUS_SDTR_ADDR,
              ...
              BUS_SDTR_WR_2 |  //over tWR(22ns)
              BUS_SDTR_RP_2 |  //over tRP(18ns) Tsd*2
              BUS_SDTR_RCD_2 | //over tRCD(18ns) Tsd*2
              BUS_SDTR_RAS_3  //over tRAS(40ns) Tsd*3
              );
  ...
  sil_wrh_mem((uint16_t*)BUS_SDRFCR_ADDR,
              BUS_SDRFCR_REFW_4 | //over tRFC(60ns) Tsd*4
              936  // under 7.8125usec Tsd*936
              ); //
