...
#endif
extern uint32_t * _vvector_table;
/***********************************************************************************************************************
...
//    R_BSP_SET_INTB(R_BSP_SECTOP_INTVECTTBL); wata
  //  R_BSP_SET_INTB(_vvector_table);
 //   uint32_t *tmp = _vvector_table;
...
#if BSP_CFG_RTOS_USED != 6  /* enable in Toppers  */
