...
Macro definitions
***********************************************************************************************************************/
#if (BSP_CFG_RTOS_USED == 4) || (BSP_CFG_RTOS_USED == 6) /* Renesas RI600V4 & RI600PX or Toppers*/
...
#if BSP_CFG_RTOS_USED != 6    /* Toppers  */
...
#if (BSP_CFG_RTOS_USED == 0) || (BSP_CFG_RTOS_USED == 5) || (BSP_CFG_RTOS_USED == 6)   /* Non-OS or Azure RTOS or Toppers*/
